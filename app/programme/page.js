    ...
    <main class="mx-4 w-screen min-h-lvh h-full flex-col items-center justify-center ">
      ...
      <div class="my-6 pb-4 mx-auto flex-col justify-center items-center bg-white min-h-screen md:max-w-screen-sm lg:max-w-screen-md xl:max-w-screen-lg 2xl:max-w-screen-xl rounded-3xl ">
        ...
        <div class="mb-10 flex-col justify-center items-center">
          <h2 class="flex justify-center items-center mb-5 mx-auto">
            <FontAwesomeIcon
              icon={faCalendarDays}
              size="xl"
          ...
          <div class="flex-col justify-center items-center">
            ...
            <div class="flex justify-center items-center flex-1 my-4">
              <div class="mr-2 text-right">18h</div>
            ...
            <div class="flex-col justify-center items-center m-4 ">
              <div class="flex justify-center items-center">
                ...
                <a
                  ...
                  class="m-3 underline text-center"
                >
                  Château de Bourguignon | 77370 Fontains
                </a>
              </div>

              <div class="text-xs text-center">Parking sur place</div>
            </div>
          </div>
        </div>
      </div>
